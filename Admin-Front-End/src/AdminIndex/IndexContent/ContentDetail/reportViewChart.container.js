...
class ReportViewChartContainer extends Component {
    ...
    render() {
        ...
        for (let i = 0; i < reportNumberPeopleFollowDestination.length; i++) {
            ...
            for (let k = 1; k <= 12; k++) {
                ...
                for (
                    ...
                    if (j === 1) {
                        ...
                        dataMonth = {
                            ...dataMonth,
                            [reportNumberPeopleFollowDestination[i][j][0]]:
                                temp,
                        };
                    }
                }
            ...
            console.log(dataReportNumberPeopleFollowDestinationAll);
        }
                ...
                <div className="row">
                    ...
                    <div className="col-xl-4 col-lg-5">
                        <div className="card shadow mb-4">
                            ...
                            <div className="card-body">
                                <CircleChart
                                    dataCount={reportNumberOfTourists}
                                />
                            </div>
                        </div>
                    </div>
                ...
                <div className="row">
                    <div className="col-xl-12 col-lg-12">
                        <div className="card shadow mb-4">
                            <div className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 className="m-0 font-weight-bold text-primary">
                                    Thống kê lượng khách theo thời gian của từng
                                    khu vực
                                </h6>
                            ...
                            <div className="card-body">
                                {where === "all" ? (
                                    <ColumnChartAll
                                        data={
                                            dataReportNumberPeopleFollowDestinationAll
                                        }
