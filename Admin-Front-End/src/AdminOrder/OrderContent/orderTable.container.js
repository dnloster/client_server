...
class EditableCell extends React.Component {
    getInput = () => {
        if (this.props.inputType === "number") {
            return <InputNumber />;
        } else if (this.props.inputType === "disabled")
    ...
    render() {
        ...
        this.columns = [
            ...
            },
            {
                ...
                sorter: (a, b) =>
                    a.numberChildren.length - b.numberChildren.length,
                sortOrder:
                    sortedInfo.columnKey === "numberChildren" &&
                    sortedInfo.order,
                ellipsis: true,
                editable: true,
            },
                                ...
                                <div className="row no-gutters align-items-center">
                                    <div className="col mr-2">
                                        <div className="text-xs font-weight-bold text-success text-uppercase mb-1">
                                            Tổng số lượt người dùng đặt tour
                                        </div>
