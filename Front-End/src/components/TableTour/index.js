    ...
    render() {
        ...
        this.columns = [
            ...
            },
            {
                ...
                sortOrder:
                    sortedInfo.columnKey === "titleTour" && sortedInfo.order,
                ellipsis: true,
                editable: true,
                // render: text => text
            },
            ...
            },
            {
                ...
                sortOrder:
                    sortedInfo.columnKey === "address" && sortedInfo.order,
                ellipsis: true,
                editable: true,
            },
            {
            ...
            },
            {
                ...
                sortOrder:
                    sortedInfo.columnKey === "dateAdded" && sortedInfo.order,
                ellipsis: true,
                editable: true,
            },
            {
            ...
            },
            {
                ...
                sortOrder:
                    sortedInfo.columnKey === "describe" && sortedInfo.order,
                ellipsis: true,
                editable: true,
            },
            {
...
const TableTour = Form.create()(EditableTable);
...
export default connect(mapStateToProps, mapDispatchToProps)(TableTour);
