...
import { MOMO_ERROR_CODE } from "~/App/apis/index";
...
class ResultSuccessfulMomo extends Component {
    ...
    componentDidMount() {
        ...
        const { fetchSetStatusPaidRequest, fetchSetStatusFailedRequest } =
            orderAllActions;
    ...
    render() {
        ...
        return (
            <Result
                status={
                    errorCode === MOMO_ERROR_CODE.SUCCESS ? `success` : `error`
                }
                title={
                    <div>
                ...
                subTitle={
                    errorCode === MOMO_ERROR_CODE.SUCCESS ? (
                        <div>
                            ...
                            <p>
                                Chúng tôi sẽ gửi mail cho bạn để xác nhận đã
                                thanh toán với mã PIN và đơn hàng, Xin hãy kiểm
                                tra và lưu lại!
                            </p>
                            {message}
                        </div>
                        ...
                        <div>
                            ...
                            <p>
                                Xin hãy kiểm tra và thanh toán lại hoặc liên hệ
