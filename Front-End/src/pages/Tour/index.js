...
import SearchEngineTourPage from "~/components/SearchEngine/SearchEngineTourPage";
...
class Tour extends Component {
                    ...
                    (e) =>
                        (e.titleTour
                            ...
                            e.describe
                                .toLowerCase()
                                .includes(
                                    valueSearch.keySearch.toLowerCase()
                                ) ||
                            e.address
                                .toLowerCase()
                                .includes(
    ...
    renderTours = () => {
        ...
        if (
            ...
            listTours = this.handleSearchListTourWithValue(
                listTours,
                valueSearch
            );
        }
                                        ...
                                        <div className="mb-3">
                                            ...
                                            >
                                                <Checkbox
                                                    indeterminate={
                                                        this.state
                                                            .indeterminateCostOption
                                                    }
                                                    onChange={
                                                        this
                                                            .onCheckAllChangeCostOption
                                                    }
                                                    checked={
                                                        this.state
                                                            .checkAllCostOption
                                        ...
                                        <div className="mb-3">
                                            ...
                                            >
                                                <Checkbox
                                                    indeterminate={
                                                        this.state
                                                            .indeterminateTourTypeOption
                                                    }
                                                    onChange={
                                                        this
                                                            .onCheckAllChangeTourTypeOption
                                                    }
                                                    checked={
                                                        this.state
                                                            .checkAllTourTypeOption
                                                    }
                                                >
                                                    Chọn lọc tất cả
                                                </Checkbox>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            >
                                                <Checkbox
                                                    indeterminate={
                                                        this.state
                                                            .indeterminateServiceMore
                                                    }
                                                    onChange={
                                                        this
                                                            .onCheckAllChangeServiceMore
                                                    }
                                                    checked={
                                                        this.state
                                                            .checkAllServiceMore
                                        ...
                                        <div className="mb-3">
                                            ...
                                            >
                                                <Checkbox
                                                    indeterminate={
                                                        this.state
                                                            .indeterminateTourTheme
                                                    }
                                                    onChange={
                                                        this
                                                            .onCheckAllChangeTourTheme
                                                    }
                                                    checked={
                                                        this.state
                                                            .checkAllTourTheme
