...
import TourDetailImg from "~/pages/Tour/TourDetailImages";
...
const marksEvaluate = {
    1: {
        ...
        label: (
            <strong
                style={{ width: "70px", position: "absolute", left: "-25px" }}
            >
                "Rất tệ"
            </strong>
        ),
...
export default class TourSingleContainer extends Component {
    ...
    renderEvaluates = () => {
        ...
        const evaluateHeart = evaluates.filter(
            (e) => e.typeEvaluate === "heart"
        );
                        ...
                        <div className="col-sm-12 col-md-6 col-lg-4 ht-detail-tour-info-container ftco-animate">
                            ...
                            <div className="ht-info-container-2 ftco-animate">
                                <div className="ht-departure-day">
                                    <p>
                                        <i className="far fa-calendar"></i> Khởi
                                        hành:{" "}
                                    </p>
                                    <p>
                                    ...
                                    <Dropdown
                                        overlay={this.renderMenuDepartureDay(
                                            tourById
                                        )}
                                    >
                                        <Button size="small">
                                ...
                                <div className="ht-time-location">
                                    <p>
                                        <i className="far fa-clock"></i> Thời
                                        gian:{" "}
                                    </p>
                                    <p>
                            ...
                            <div className="ht-info-container-4 ftco-animate">
                                <div className="ht-support">
                                    Nếu cần hỗ trợ, Gọi cho chúng tôi ngay bây
                                    giờ: 0983 982 933
                                </div>
