...
class BookTourStep2 extends Component {
    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
            ...
            if (!err) {
                message.success(
                    "OK! Bây giờ bạn có thể đến bước tiếp theo rồi"
                );
    ...
    calTotalPrice = () => {
        const { numAdult, numChild, numChild2To6Age } = this.state;
        const { tourById } = this.props;
        const officalPrice = tourById.price * (1 - tourById.sale * 0.01);
        const newTotalPrice =
            officalPrice * (numAdult + numChild * 0.5 + numChild2To6Age * 0.2);
                ...
                <div className="ht-d-flex-col-start-start">
                    <div className="ht-book-tour-info-container container">
                                    ...
                                    rules: [
                                        {
                                            ...
                                            required: true,
                                            message:
                                                "Xin hãy chọn nơi cư trú của bạn!",
                                        },
                                    ],
                                })(
                                    <Cascader
                        ...
                        <div className="ht-book-tour-info-right container">
                            ...
                            <Form.Item
                                label={<span>Bạn đi theo hình thức nào</span>}
                                style={{ paddingBottom: 12 }}
                            >
                                {/* <Cascader
                                    style={{ width: "100%" }}
