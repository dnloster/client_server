...
export default class BookTourStep3 extends Component {
    ...
    render() {
        const { size, checkout } = this.state;
        const { data, dataMomo, dataPayPal } = this.props;
                        ...
                        <div className="row ht-payment-container">
                                ...
                                <div className="thumbnail ht-thumbnail-container">
                                    ...
                                    <div className="caption">
                                        <p>
                                            ...
                                            nhất, tạo môi trường thanh toán trực
                                            tuyến an toàn và tiện lợi nhất{" "}
                                            <Link
                            ...
                            <div className="col-sx-12 col-sm-6 col-md-3">
                                <div className="thumbnail ht-thumbnail-container">
                                    ...
                                    <div className="caption">
                                        <p>
                                            Thuộc top 100 sản phẩm, dịch vụ Việt
                                            Nam được tin dùng, là nhãn hiệu nổi
                                            tiếng trong phạm vi toàn quốc{" "}
                                            <a
                                                href="https://www.paypal.com/vn/home?locale.x=vi_VN"
                                                className="ht-text-underline"
                                                target="_blank"
                            ...
                            <div className="col-sx-12 col-sm-6 col-md-3">
                                <div className="thumbnail ht-thumbnail-container">
                                    ...
                                    <div className="caption">
                                        <p>
                                            Cổng thanh toán đa dạng kênh uy tín,
                                            Ưu việt hàng đầu Việt Nam. Liên kết
                                            h ơn 20 ngân hàng trong nước và Quốc
                                            tế{" "}
                                            <a
                                                href="https://zalopay.vn/hoi-dap/quan-ly-tai-khoan/khoa-mo-khoa-tai-khoan"
                                                className="ht-text-underline"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                            >
                            ...
                            <li className="list-group-item">
                                <Title level={4}>
                                    ...
                                    <Tooltip
                                        placement="left"
                                        title={
                                            "Đây là số thẻ của administrator"
                                        }
                                    >
                                        <i
                            ...
                            <li className="list-group-item">
                                <Title level={4}>
                                    ...
                                    <Tooltip
                                        placement="left"
                                        title={
                                            "Đây là số tài khoản của administrator"
                                        }
                                    >
                            ...
                            <li className="list-group-item">
                                <Title level={4}>
                                    ...
                                    <Tooltip
                                        placement="left"
                                        title={
                                            "Nội dung là số điện thoại của bạn"
                                        }
                                    >
